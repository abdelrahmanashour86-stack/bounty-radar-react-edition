...
const ServerError = () => {
    return ( 
        <div className="w-full h-screen flex flex-col items-center justify-center">
          <svg
            className="w-1/2 md:w-1/3 lg:w-1/4 text-(--color-important)"
          ...
          <div className="flex flex-col items-center justify-center">
            ...
            <p className="text-2xl md:text-3xl lg:text-4xl font-bold text-(--color-hover) mt-2">
              Server Error
            </p>
            <p className="md:text-lg xl:text-xl text-(--color-hover) text-center mt-4">
